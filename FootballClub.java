public class FootballClub{
    ...
    public void setScoredGoalsCount(int scoredGoalCount) {
        this.scoredGoalsCount = scoredGoalsCount;
    }
    public void setRecivedGoalsCount(int receivedGoalsCount) {
        this.receivedGoalsCount = receivedGoalsCount;
    }
    public void setGoalsDifference(int goalDifference) {
